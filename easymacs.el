...
;; Tabs are now built in (from Emacs 27)
(global-tab-line-mode)
(bind-key* (kbd "<C-tab>") 'tab-line-switch-to-next-tab)
(bind-key* (kbd "<C-S-tab>") 'tab-line-switch-to-prev-tab)
;; This is forthcoming in Emacs 28
(setq tab-line-switch-cycling t)

;; Remove interfering mappings
